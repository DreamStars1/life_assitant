...
declare global {
  ...
  const useCalendar: typeof import('../composables/useCalendar').useCalendar
  ...
  const usePush: typeof import('../composables/usePush').usePush
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { CalendarView } from '../composables/useCalendar'
